...
class DroidPathGeneratorTest extends TestCase
{
     ...
     * @covers ::__construct
     */
    public function testThrowsInitialDirectionIsUnknown(): void
    {
        $this->expectException(\InvalidArgumentException::class);
        $this->pathGenerator = new DroidPathGenerator([0], 5);
    }
     ...
     * @covers ::getNewPath
     */
    public function testTurnsLeftIfLeftForwardCrashed(): void
    {
        self::assertSame(
            [0, 1, 0, -1, -1],
            (new DroidPathGenerator([0, 1, 0, -1, 0], -1))->getNewPath('crashed')
        );
    }
     ...
     * @covers ::getNewPath
     */
    public function testSamePathWhenSuccess(): void
    {
        self::assertSame(
            [0, 1, 0, 1, 1, 1],
